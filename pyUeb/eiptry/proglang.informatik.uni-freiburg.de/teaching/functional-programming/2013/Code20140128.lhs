> {-# LANGUAGE TypeOperators, MultiParamTypeClasses, FlexibleInstances, FlexibleContexts, UndecidableInstances, IncoherentInstances #-}
> module Code20140128 where
...
>   fmap h (Impure t) = Impure (fmap (fmap h) t)
...
As an example, consider a calcular with three actions on a memory cell.
