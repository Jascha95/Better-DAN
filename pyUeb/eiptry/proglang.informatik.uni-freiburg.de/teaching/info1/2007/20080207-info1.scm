...
#reader(lib "DMdA-advanced-reader.ss" "deinprogramm")((modname 20080207-info1) (read-case-sensitive #f) (teachpacks ()) (deinprogramm-settings #9(#f write repeating-decimal #t #t none datum #f ())))
    ...
    (cond
      ((closure? proc)
       (let ((body (closure-exp proc))
         ...
         (let ((new-env (make-frame env (map make-entry vars args))))
